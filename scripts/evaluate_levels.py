...
parser.add_argument("--testing-levels-path", required=True,
                    help="path to testing levels (REQUIRED)")
...
if __name__ == "__main__":
    ...
    csv_path = os.path.join(utils.storage_dir(), utils.expr_group_name(), "zeroshot_{}.csv".format(args.model))
